...
interface DropdownUserProps {
  session: Session; // Annotate the type of the session prop
}

const DropdownUser: React.FC<DropdownUserProps> = ({ session }) => {
    ...
    <div className="relative">
      <Link
        ...
        <span className="hidden text-right lg:block">
          <span className="block text-sm font-medium text-black dark:text-white">{fullName}</span>
      ...
      <div
        ...
        <Link onClick={handleLogout} to="/auth/signin">
