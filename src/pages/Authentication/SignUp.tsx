...
const SignUp: React.FC = () => {
  ...
  const [signFormData, setSignFormData] = useState<SignFormProps>({
    name: '',
    email: '',
    tel: '',
    password: '',
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setSignFormData((prevData) => ({ ...prevData, [name]: newValue }));
  };
  ...
  const handleBlur = (name: keyof SignFormProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!signFormData.name) {
      validationErrors.name = ERROR_MESSAGE.name;
    }
    if (!signFormData.tel) {
      validationErrors.tel = ERROR_MESSAGE.tel;
    }
          ...
          <div className="w-full border-stroke dark:border-strokedark lg:w-1/2 lg:border-l-2">
            <div className="w-full p-8 sm:p-12.5 xl:p-17.5">
              ...
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Sign Up to Lubesurgeons
              </h2>
              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  {authMessage && <h3 className="text-center text-danger mb-5">{authMessage}</h3>}
                  {successMessage && (
                    <h3 className="text-center text-success mb-5 text-lg">{successMessage}</h3>
                  )}
                  ...
                  <div className="relative">
                    ...
                    />
                    {errors.name && <p className="text-danger text-sm italic">{errors.name}</p>}
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleChange}
                    />
                    {errors.tel && <p className="text-danger text-sm italic">{errors.tel}</p>}
                    <span className="absolute right-4 top-4">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="22"
                ...
                <div className="mb-8">
                  ...
                  <label htmlFor="formCheckbox" className="flex cursor-pointer mt-4">
