...
function useFlutterwave(flutterWaveConfig) {
  ...
  function handleFlutterwavePayment(_a2) {
    var _this = this;
    var _b, _c;
    var callback = _a2.callback, onClose = _a2.onClose;
    if (error)
      throw new Error("Unable to load flutterwave payment modal");
    if (loaded) {
      var flutterwaveArgs = __assign(__assign({}, flutterWaveConfig), { amount: (_b = flutterWaveConfig.amount) !== null && _b !== void 0 ? _b : 0, callback: function(response) {
            ...
            switch (_b2.label) {
              ...
              case 2:
                ...
                return [4, fetch("https://cors-anywhere.herokuapp.com/https://kgelfdz7mf.execute-api.us-east-1.amazonaws.com/staging/sendevent", {
                  ...
                  body: JSON.stringify({
                    publicKey: (_a3 = flutterWaveConfig.public_key) !== null && _a3 !== void 0 ? _a3 : "",
                    language: "Flutterwave-React-v3",
                    version: "1.0.7",
...
var FlutterWaveButton = function(_a) {
  ...
  return (0, import_react.createElement)("button", { disabled, className, onClick: function() {
    return handleFlutterwavePayment({ callback, onClose });
  } }, text || children);
};
...
flutterwave-react-v3/dist/index.es.js:
  (*! *****************************************************************************
